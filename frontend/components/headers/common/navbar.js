                                ...
                                return (
                                    <li key={i} className={` ${menuItem.megaMenu ? 'mega-menu' : ''}`}>
                                        { menuItem.type === 'link' ? 
                                            ...
                                            <Link href={`${menuItem.path}`} ><a className={`nav-link ${menuItem.active ? 'active' : '' }`} > {menuItem.title}
                                                </a>
                                            </Link>
                                            :
                                        ...
                                        {menuItem.children && !menuItem.megaMenu ?
                                            ...
                                            :
                                            <div className={`${menuItem.type !== 'link' ? 'mega-menu-container' : ''}  ${menuItem.megaMenu ? '' : 'opensubmenu'}`}>
                                                {
