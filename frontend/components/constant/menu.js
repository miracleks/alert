...
export const MENUITEMS = [
   ...
   { title: 'Mission', type: 'link', path: '/page/mission' },
   { title: 'Buy1save1', type: 'link', path: '/buy1save1' },
   { title: 'News', type: 'link', path: '/news' },
   { title: 'Faq', type: 'link', path: '/faq' },
   { title: 'Contact us', type: 'link', path: '/contact' },
   { title: 'Login', type: 'link', path: '/login' },
];